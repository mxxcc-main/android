package com.qy.ccm.view.group.banner;
...
import com.qy.ccm.R;
import com.qy.ccm.view.group.banner.layoutmanager.BannerLayoutManager;
import com.qy.ccm.view.group.banner.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setColor(ContextCompat.getColor(context, R.color.color_828EA1));
            selectedGradientDrawable.setSize(dp2px(8), dp2px(2));
//            selectedGradientDrawable.setCornerRadius(dp2px(2));
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setColor(ContextCompat.getColor(context, R.color.color_CFffffff));
            unSelectedGradientDrawable.setSize(dp2px(8), dp2px(2));
//            unSelectedGradientDrawable.setCornerRadius(dp2px(2));
...
//        params.setMargins(marginLeft, 0, marginRight, marginBottom);
    ...
    public interface AddBannerScrollListener {
        void onScrollListener(int positon);
    }
}