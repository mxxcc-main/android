package com.qy.ccm.view.group.password;
...
public class PayPwdEditText extends RelativeLayout {
    ...
    public void initShowInput(int bgcolor, int pwdlength, float slpilinewidth, int splilinecolor, int pwdcolor, int pwdsize) {
        ...
        for (int i = 0; i < textViews.length; i++) {
            ...
            Drawable drawable = getContext().getResources().getDrawable(R.drawable.edit_num_bg3);
...
//                textViews[i].setTextColor(ContextCompat.getColor(context, splilinecolor));
