...
public class PrivateImportWalletInAty extends BaseAty {
    ...
    @Override
    public int initView() {
        return R.layout.aty_import_privatekey_in;
    }
    ...
    public void setListener() {
        create_wallet_buttom_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("".equals(private_key_id.getText().toString().trim())) {
                    Utils.Toast("私钥不能为空");
                    return;
                }
...
//                    pow.initStyle(R.drawable.edit_num_bg2, 6, 0.33f, R.color.black, R.color.black, 30);
                ...
                pow_button.setOnClickListener(view3 -> {
                    ...
                    if (!StringUtils.isEmpty(testPass)) {
                        ...
                        new PrivateImportWalletInAty.MyAsyncTask().execute(private_key_id.getText().toString(), wallet_name_id.getText().toString().trim(), coin, tradePwd);
    ...
    class MyAsyncTask extends AsyncTask<String, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(String... strings) {
            ...
            //获取传进来的参数
            String privateKey = strings[0];
            String name = strings[1];
            String coin = strings[2];
            String pow = strings[3];
            newAddress = BlockChainUtils.imputPricate(privateKey, pow, coin, name);
            if (newAddress == null) {
                return null;
            }
