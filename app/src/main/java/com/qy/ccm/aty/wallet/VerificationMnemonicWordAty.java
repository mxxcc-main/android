 ...
 * Description:助记词验证
 */
public class VerificationMnemonicWordAty extends BaseAty {
...
//                if (1 == 1) {
                    ...
                    Utils.Toast("助记词验证成功");
                    tvVerificationMnemonic.setText("");
                    if ("1".equals(Config.getCustomerId())) {
...
//                    }
    ...
    @Override
    public int initView() {
        return R.layout.export_nonemic_word_verify;
    }
